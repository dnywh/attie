...
describe("fixture API helpers", () => {
  ...
  it("builds ESPN URLs for soccer competitions", () => {
    const url = buildFixtureApiUrl(COMPETITIONS["premier-league"], {
      dateFrom: "2026-08-15",
      dateTo: "2026-08-16",
      direction: "future",
    });
    ...
    expect(url).toBe(
      "/api/espn?dateFrom=2026-08-15&dateTo=2026-08-16&direction=future&sport=soccer&league=eng.1"
    );
  });
